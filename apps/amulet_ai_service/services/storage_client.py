...
class StorageClient:
    ...
    def _ensure_buckets(self):
        ...
        for bucket in buckets:
            try:
                ...
                # Connection error - log warning and skip bucket creation
                # S3 might not be ready yet during startup
                logger.warning("storage_unavailable_skipping_bucket", bucket=bucket, error=str(e))
                continue
    ...
    def list_objects(self, bucket: str, prefix: str = "", recursive: bool = True) -> List[str]:
        ...
        try:
            ...
            # Note: recursive parameter is for MinIO compatibility, boto3 lists recursively by default
